...
datapath <- 'C:\\Users\\LiWeiJun\\Desktop\\data anaylst\\lab\\lab3\\group2\\rollingsales_bronx.xls'
bronx1 <- read.xlsx(file = datapath, sheet = "Bronx", startRow = 5, colNames = TRUE)
